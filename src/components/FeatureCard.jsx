...
const FeatureCard = ({ title, description, icon = "folder_supervised" }) => {
    return (<div className="w-full max-w-[247px] bg-white-custom rounded-[18px] p-[16px] flex flex-col items-center text-center gap-[16px] shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
